...
google.load("visualization", "1", {packages:["ImageChart"]});
	...
	if(blnGrupoSinDato == true)
	{
		...
		//chd:'t0:-1,20,26,15,25,-1|-1,5,10,7,12,-1|-1,25,45,47,24,-1|-1,40,30,27,39,-1|-1,63,80,59,80,-1',    No se usa, se pone en datetable
		chls:strhdls, //'1|1|1|1|1'
		chartArea:{left:75,top:75,width:"75%"},
		chm:'F,0000FF,0,1:'+(numfilas-1)+',20|H,FF0000,0,0:'+(numfilas-1)+',1:20|H,0CBF0B,3,1:'+(numfilas-1)+',1:20|H,000000,4,1:'+(numfilas-1)+',1:20|o,FF8C00,5,1:'+(numfilas-1)+',10',
