...
document.getElementById('pstPA').className ="pestania_activa";
document.getElementById('pstPAtr').className ="pestania";
document.getElementById('pstPAleat').className ="pestania";

    if(window.addEventListener){
      window.addEventListener('load',function(){
        graf = new Grafica ('ColumnChart',document.getElementById('grafica'),document.getElementById('tdGraficas'));
        init();
        inicializarFiltros('graficaperfilalumnado')
      },true);
    }
    else{
