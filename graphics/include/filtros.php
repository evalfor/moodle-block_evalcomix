...
?>
    ...
    <div class="filter">
        <div id="divtipografica" class="campo" style="display: none;">
            <input id="rbalumno" type="radio" name="tipocalificacion" value="Alumno" onclick="cambio_radiobutton(4);">
            <label id="divtipoalumno"> Alumno </label>
            <input id="rbgrupo" type="radio" name="tipocalificacion" value="Grupo" onclick="cambio_radiobutton(2);">
            <label id="divtipogrupo"> Grupo </label>
            <input id="rbclase" type="radio" name="tipocalificacion" value="Clase" onclick="cambio_radiobutton();">
            <label id="divtipoclase"> Clase </label>
        </div>
    </div>

    <div class="filter">
      <div id="divtipografica2" class="campo" style="display: none;">
          <input id="rbprofesor" type="radio" name="tipocalificacion2" value="Alumno" onclick="cambio_radiobutton(4);">
          <label id="divtipoprofesor"> Profesor </label>
          <input id="rbei" type="radio" name="tipocalificacion2" value="Grupo" onclick="cambio_radiobutton(4);">
          <label id="divtipoei"> Entre iguales </label>
      </div>
    </div>
  ...
  <li style="display:inline"> <label><input id="chkbxlimite" name="limite" type="checkbox"
  onClick="cambio_filtro_limites(); mostrar_grafica();" /> Limite?</label></li>
  <li style="display:inline"> <select id="cmbxlimite" name="cmbxlimite" size=1
  onChange="cambio_filtro_limites_k(); mostrar_grafica();">
  ...
  <li style="display:inline"> <label><input id="chkbxdispersion" name="dispersion" type="checkbox"
  onClick="cambio_filtro_dispersion(); mostrar_grafica();" /> Ver dispersión?</label></li>
  </ul>