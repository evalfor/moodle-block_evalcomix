...
$string['closeview'] = 'Cerrar vista previa';
...
$string['weightedaveragesmartwithreduction'] = 'Media ponderada de calificaciones no extremas con reducción';
...
$string['token'] = 'Token';
$string['tokeninfo'] = 'Token generado por EvalCOMIX Server. Para obtenerlo, accede al panel de control de EvalCOMIX Server para dar de alta este Moodle como LMS permitido.';
...
Si se selecciona la opción **' . $string['specificstudents_EI'] . '** se podrá indicar quiénes evaluarán y quiénes serán evaluados. No obstante, si, además, se selecciona la opción "Equipos de trabajo", se aplicarán las siguientes restricciones: 1) Un miembro de un equipo no podrá evaluar a otro miembro de su mismo equipo y 2) los coordinadores de los equipos de trabajo no se mostrarán en el apartado de Estudiantes Evaluadores, pero sí en el de Estudiantes Candidatos';
...
Si hay **Evaluación entre Iguales – EI**, los alumnos solo podrán evaluar  a los coordinadores de cada grupo y cada evaluación se le asignará a cada miembro del grupo. Este comportamiento podrá ser modificado si se selecciona la opción "Estudiantes Específicos" y se asigna quién evalúa a quién.
