...
$string['handlerofco'] = 'Διαχείριση δεξιοτήτων και μαθησιακά αποτελέσματα';
$string['competencies'] = 'Αρμοδιότητες';
$string['outcomes'] = 'Μαθησιακά αποτελέσματα';
$string['compidnumber'] = 'Κώδικας';
$string['compshortname'] = 'Μικρό όνομα';
$string['compdescription'] = 'Περιγραφή';
$string['comptypes'] = 'Τύποι ανταγωνισμού';
$string['comptype'] = 'Τύπος διαγωνισμού';
$string['newcomp'] = 'New Comp';
$string['newoutcome'] = 'Νέο μαθησιακό αποτέλεσμα';
$string['newcomptype'] = 'Νέος Τύπος Comp';
$string['compreport'] = 'έκθεση ανάπτυξης';
$string['compandout'] = 'Ικανότητες και μαθησιακά αποτελέσματα';
$string['uploadcompetencies'] = 'Εισαγωγή ικανοτήτων και αποτελεσμάτων';
$string['uploadcompetencies_help'] = 'Οι ικανότητες και τα μαθησιακά αποτελέσματα μπορούν να μεταφορτωθούν μέσω ενός αρχείου κειμένου. Η μορφή αρχείου θα πρέπει να είναι η εξής:

* Κάθε γραμμή του αρχείου περιέχει μία εγγραφή
* Κάθε εγγραφή είναι μια σειρά δεδομένων που χωρίζονται με κόμματα (ή άλλους οριοθέτες)
...
$string['ignored'] = 'Παράβλεψη';
$string['errors'] = 'Σφάλματα';
$string['importresult'] = 'Εισαγωγή αποτελεσμάτων';
$string['uploadcompetenciespreview'] = 'Προεπισκόπηση μεταφορτωμένων ικανοτήτων';
$string['choicecompetency'] = 'Επιλέξτε έναν διαγωνισμό';
$string['choiceoutcome'] = 'Επιλέξτε ένα αποτέλεσμα';
$string['associatecompandout'] = 'Συσχετίστε τις ικανότητες και τα αποτελέσματα';
$string['allstudens'] = 'Όλοι οι μαθητές';
$string['onestudent'] = 'Συγκεκριμένος μαθητής';
$string['onegroup'] = 'συγκεκριμένη ομάδα';
$string['evaluationandreports'] = 'Αξιολόγηση και εκθέσεις';
$string['workteams'] = 'Ομάδες εργασίας';
$string['workteamsassessments'] = 'Αξιολόγηση ομάδων εργασίας';
$string['assignteamcoordinators'] = 'Ορίστε συντονιστές ομάδων';
$string['workteamsassessments_help'] = 'Εάν ενεργοποιήσετε αυτήν την επιλογή, θα μπορείτε να ορίσετε έναν συντονιστή για να εκπροσωπήσει την ομάδα.

Εάν υπάρχει **Αξιολόγηση δασκάλων - EP**, οι δάσκαλοι θα μπορούν να αξιολογήσουν μόνο τους συντονιστές και αυτή η αξιολόγηση θα ανατεθεί σε κάθε μέλος της ομάδας τους.
...
$string['alertnogroup'] = 'Δεν έχουν δημιουργηθεί ακόμη ομάδες στο μάθημα. Για να τα δημιουργήσετε πρέπει να έχετε πρόσβαση στην παρακάτω ενότητα:';
$string['activityassessed'] = 'Απενεργοποιήθηκε επειδή ένας μαθητής έχει ήδη δοκιμαστεί';
$string['coordinatorassessed'] = 'Επί του παρόντος, υπάρχουν συντονιστές που έχουν ήδη λάβει κάποια αξιολόγηση. Όσοι έχουν λάβει αξιολόγηση δεν μπορούν να αντικατασταθούν. Εάν θέλετε να τα αντικαταστήσετε, θα πρέπει πρώτα να διαγράψετε τις κριτικές.';
$string['confirmdisabledworkteams'] = 'Έχουν ήδη πραγματοποιηθεί αξιολογήσεις σε αυτή τη δραστηριότητα. Εάν απενεργοποιήσετε αυτήν την επιλογή και αποθηκεύσετε τις αλλαγές σας, όλες αυτές οι αξιολογήσεις θα διαγραφούν και δεν θα μπορούν να ανακτηθούν. Είστε βέβαιοι ότι θέλετε να απενεργοποιήσετε την επιλογή;';
$string['itemaddedsuccessfully'] = 'Το στοιχείο προστέθηκε με επιτυχία';
$string['duplicatevalue'] = 'Διπλότυπη τιμή';
$string['itemmodifiedsuccessfully'] = 'Το στοιχείο τροποποιήθηκε με επιτυχία';
$string['itemdeletedsuccessfully'] = 'Το στοιχείο διαγράφηκε επιτυχώς';
$string['lastconfirmdeletetool'] = 'ΠΡΟΕΙΔΟΠΟΙΗΣΗ: Το παρακάτω εργαλείο αξιολόγησης έχει συσχετίσει {$a} αξιολογήσεις. Εάν το διαγράψετε, όλες οι σχετικές αξιολογήσεις θα διαγραφούν επίσης. Εισαι σιγουρος οτι θελεις να συνεχισεις?';
