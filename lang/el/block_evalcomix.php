 ...
 */
 ...
 Περισσότερες πληροφορίες για βρείτε στο <a href="' . $CFG->wwwroot.'/lib/evalcomix/manual.pdf">Manual</a>';
	...
	$string['whatis_help'] = 'Το EvalCOMIX επιτρέπει το σχεδιασμό και τη διαχείριση εργαλείων αξιολόγησης (βαθμολογικές κλίμακες, ρουμπρικές, κ.λπ.) που μπορούν να χρησιμοποηθούν για την πρόσβαση σε μία ομάδα συζήτησης (forum), για γλωσσάρια, βάσεις δεδομένων, wiki και δραστηριότητες.<br> 
Η αξιολόγηση με αυτά τα εργαλεία μπορεί να λάβει χώρα από εκπαιδευτικούς (αξιολόγηση από τον εκπαιδευτικό), ή τους μαθητές students (αυτοαξιολόγηση, αξιολόγηση από ισότιμους). Για περισσότερες πληροφορίες, συμβουλευτείτε το Εγχειρίδιο.
Μπορείτε να το βρείτε εδώ <a href="../manual.pdf">Manual</a>';
