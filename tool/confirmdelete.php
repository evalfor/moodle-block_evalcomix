...
if ($tooldelete = $DB->get_record('block_evalcomix_tools', ['id' => $tid])) {
    ...
    redirect(new moodle_url($CFG->wwwroot . '/blocks/evalcomix/tool/index.php', ['id' => $courseid]));
}

$PAGE->set_url(new moodle_url('/blocks/evalcomix/tool/confirmdelete.php', ['id' => $courseid, 'tool' => $tid]));
