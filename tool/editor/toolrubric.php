...
/**
 * block_evalcomix_editor_toolrubric
...
class block_evalcomix_editor_toolrubric extends block_evalcomix_editor {
    ...
    public function get_atributosid() {
        $result = (isset($this->atributosid[$this->id])) ? $this->atributosid[$this->id] : [];
        return $result;
    }
    ...
    public function __construct(
        ...
        $valueattribute = null,
        $valueglobaldim = null,
        $valuetotalvalue = null,
        $valuecommentatr = null,
        $valuecommentdim = null,
        $params = []
    ) {
     ...
     * Method
     */
    public function display_dimension($dim = 0, $data = [], $id = 0, $mix = '') {
        $id = $this->id;
        $subdim = null;
        $atrib = null;
