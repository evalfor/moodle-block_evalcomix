 ...
 */
 ...
 class evalcomix_allowedusers extends evalcomix_object{
     ...
     */
    public $required_fields = array('id', 'cmid', 'assessorid', 'studentid');
	...
	*/
	...
	public static function fetch_all($params){
		return evalcomix_allowedusers::fetch_all_helper('block_evalcomix_allowedusers', 'evalcomix_allowedusers', $params);
	}
